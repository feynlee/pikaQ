...
# %% auto 0
__all__ = ['CURRENT_ROW', 'DelayedFunc', 'delayed_func', 'as_', 'DelayedPipeline', 'eval_type', 'union2tuple', 'patch_to',
           'patch_method', 'Field', 'ArithmeticExpression', 'Criteria', 'OverClause', 'Preceding', 'Following']
