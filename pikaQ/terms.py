...
# %% auto 0
__all__ = ['CURRENT_ROW', 'FieldBase', 'Field', 'ArithmeticExpression', 'Criteria', 'kwargs_func', 'DelayedFunc', 'custom_func',
           'OverClause', 'Preceding', 'Following', 'Case']
...
class Field(FieldBase):
    ...
    def execute(self, **kwargs):
        if self.alias:
            return f"{execute(self.name, **kwargs)} AS {self.alias}"
        else:
            return f"{execute(self.name, **kwargs)}"
